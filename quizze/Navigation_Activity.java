...
public class Navigation_Activity extends AppCompatActivity
    ...
    public final static String Message = "com.F.MESSAGE";
...
//            mediaPlayer.setLooping(true);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_scorecard) {
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT, "Quizze");
            ...
            intent.setData(Uri.parse("mailto:"));
            String[] recipents = {"info.embeddedfru@gmail.com"};
            intent.setType("message/rfc822");
            intent.putExtra(Intent.EXTRA_EMAIL, recipents);
            intent.putExtra(Intent.EXTRA_SUBJECT, "Quizze Reviews");
