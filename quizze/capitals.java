...
public class capitals extends SQLiteOpenHelper {
    ...
    private static final String Database_name = "capitals.db";//NAME of database stored in Assets folder
    private static final String Table_name = "capitals";//name of table
    ...
    public capitals(Context context) {//constructor
